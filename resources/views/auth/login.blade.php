...
<!-- Mirrored from pixner.net/boleto/demo/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 15 May 2021 16:38:03 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <div class="container">
        <div class="padding-top padding-bottom">
            <div class="account-area">
                ...
                <form class="account-form" action="{{route('user.custom.login')}}" method="post">
                    @csrf
...
<!-- Mirrored from pixner.net/boleto/demo/sign-in.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 15 May 2021 16:38:04 GMT -->
</html>
